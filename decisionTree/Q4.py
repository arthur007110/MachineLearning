...
for i in range(600):
  y.append( [j for j in data[i][6:]])
  X.append([j for j in data[i][:parameter_amount]])

print(X[540:560],y[540:560])

X_train, X_test, y_train, y_test = train_test_split(X, y, test_size=0.5, random_state=10)

dt = tree.DecisionTreeClassifier(max_depth=5, criterion='log_loss')
